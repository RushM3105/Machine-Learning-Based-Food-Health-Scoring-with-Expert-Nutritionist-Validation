...
# df_input = pd.DataFrame([input_base])

# # Feature engineering
#    df_input['salt_additives'] = df_input['salt_100g'] * df_input['additives_n']
#    df_input['sugar_fiber_ratio'] = df_input['sugars_100g'] / (df_input['fiber_100g'] + 1e-6)
# df_input['protein_energy'] = df_input['proteins_100g'] * df_input['sugars_100g']
# df_input['log_additives'] = np.log1p(df_input['additives_n'])

# # Reorder and clean
#    df_input = df_input[[
#     'salt_100g', 'sugars_100g', 'saturated-fat_100g',
#     'fiber_100g', 'proteins_100g', 'additives_n',
#     'salt_additives', 'sugar_fiber_ratio',
#     'protein_energy', 'log_additives'
# ]]
